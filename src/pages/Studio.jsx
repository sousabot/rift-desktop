...
import { MODE_QUEUE } from '../lib/queues';
import { useSession } from '../state/SessionContext';
import { useI18n } from '../i18n/LocaleContext';
import { useStudioMeta, useStudioView } from '../lib/useStudioMeta';
import { getDdragonVersion, profileIconUrl, useDdragonVersion } from '../services/ddragon';
import { fmtNum, fmtPct, fmtSigned } from '../lib/studioStats';
import { RANK_COLORS, rankEmblemClass, rankImg } from '../lib/rankEmblem';
...
export default function Studio() {
  ...
  const enabled = !!session?.platform;
